  ...
  <tr>
    <td>
      ...
      Welcome to India’s No. 1 Platform for Business Documents
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #333; padding: 10px 40px 40px; margin: 0; font-family: 'Montserrat', sans-serif; font-weight: 400;">No need to worry. Click on the button below to reset your password.
    </p>
   
      <a href="{{route('resetPassword', [base64_encode($user->email)])}}" style="text-align: center; background: #55af27; padding: 10px 20px; color: #fff; border-radius: 3px; margin:0 auto 50px; display: table; text-decoration: none; font-family: 'Montserrat', sans-serif; font-weight: 500;">Reset Password</a>
    </td>
  </tr>
