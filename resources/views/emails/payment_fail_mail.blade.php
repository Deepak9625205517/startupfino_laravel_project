  ...
  <tr>
    <td>
      ...
      Welcome to India’s No. 1 Platform for Business Documents
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #333; padding: 10px 40px 40px; margin: 0; font-family: 'Montserrat', sans-serif; font-weight: 400;">Your payment is failed. Your invoice number is {{($sub['transaction_id']) ? $sub['transaction_id'] : ''}} In case your payment has been deducted, we will refund the amount very soon.</p>
