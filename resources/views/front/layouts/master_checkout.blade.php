...
<head>
      ...
      <!-- Easy Autocomplete -->
        <link rel="stylesheet" href="http://localhost/gitcode/corpbiz-doc/public/front/css/easy-autocomplete.min.css">
        <link rel="stylesheet" href="http://localhost/gitcode/corpbiz-doc/public/front/css/easy-autocomplete.themes.min.css">
...
<body>
  ...
  @include('front.layouts.header_checkout')
  ...
  <!-- Easy Autocomplete -->
  <script src="http://localhost/gitcode/corpbiz-doc/public/front/js/jquery.easy-autocomplete.min.js" type="text/javascript"></script>
  <!-- End Easy Autocomplete -->
    ...
    $('#login').on('click', function(e) {
      e.preventDefault();
        ...
        if(email == '')
        {
          ...
          $("#login").html('<button type="button" class="login-btn" value="LOGIN" id="login" disabled>LOGIN... <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><div class="spinner-border text-white" role="status"></div></button>');
          $.ajaxSetup({
              headers: {
    ...
    $('#enquiry').on('click', function(e) {
        ...
        var filter = /^\d*(?:\.\d{1,2})?$/;
         ...
         if(mobile_number == '')
          ...
          $("#enquiry").html('<button type="button" id="enquiry" disabled>DOWNLOAD... <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><div class="spinner-border text-white" role="status"></div></button>');
