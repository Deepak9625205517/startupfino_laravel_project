...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('sub-category-document-list/{id}', [AdminController::class, 'getSubcategoryDocument'])->name('get.Subcategory.Document');
    Route::get('category-document-list/{id}', [AdminController::class, 'getcategoryDocument'])->name('get.category.Document');
    ...
    Route::get('pagination-ajax', [DocumentCenterController::class, 'paginationAjax'])->name('pagination.ajax');
    ...
    Route::get('business-information', [UserAccountController::class, 'businessInformation'])->name('business.information');
    Route::get('my-team', [UserAccountController::class, 'myTeam'])->name('my.team');
    Route::get('license', [UserAccountController::class, 'license'])->name('license');
    Route::get('billing', [UserAccountController::class, 'billing'])->name('billing');
    Route::get('download-invoice', [UserAccountController::class, 'downloadInvoice'])->name('download.invoice');
});
...
Route::get('templates/{cat_slug}', [FrontendController::class, 'subcategoryList'])->name('templates.category');
Route::get('templates/{cat_slug?}/{sub_cat_slug?}', [FrontendController::class, 'documentsList'])->name('templates.subcategory');
...
Route::get('templates/load-more-document-list/{category_id}', [FrontendController::class, 'documentListLoadMore'])->name('templates.document_list');
...
Route::get('contact-thankyou', [FrontendController::class, 'contactThankyou'])->name('contact.thankyou');
