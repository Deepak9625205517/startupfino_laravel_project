  ...
  <tr>
    <td>
      ...
      Welcome to India’s No. 1 Platform for Business Documents
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #333; padding: 10px 40px 40px; margin: 0; font-family: 'Montserrat', sans-serif; font-weight: 400;">Click on the link given below and create your account.
         </p>
         <a href="{{url('https://bizkit.in/signup?refferal_code='.Auth::user()->refferal_code)}}">{{url('https://bizkit.in/signup?refferal_code='.Auth::user()->refferal_code)}}</a>
