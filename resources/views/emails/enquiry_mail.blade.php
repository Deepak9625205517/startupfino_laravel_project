  ...
  <tr>
    <td>
      ...
      Welcome to India’s No. 1 Platform for Business Documents
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #333; padding: 10px 40px 40px; margin: 0; font-family: 'Montserrat', sans-serif; font-weight: 400;">Thank you for your inquiry regarding our business documents. From HR templates, forms, and CEO emails to legal agreements, sales and marketing documents, etc., we have everything in our package that can help you grow your business along with saving your time and money. We hope that the details mentioned on the website are useful for you.
    </p>
    <p style="font-size: 15px; line-height: 1.6; color: #333; padding: 10px 40px 40px; margin: 0; font-family: 'Montserrat', sans-serif; font-weight: 400;">Please reach out to us if you have additional queries. Thanks again.
    </p>
      <a href="{{route('subscription')}}" style="text-align: center; background: #55af27; padding: 10px 20px; color: #fff; border-radius: 3px; margin:0 auto 50px; display: table; text-decoration: none; font-family: 'Montserrat', sans-serif; font-weight: 500;">Download</a>
    </td>
  </tr>
